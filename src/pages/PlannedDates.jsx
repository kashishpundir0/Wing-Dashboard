              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {group.items.map((d) => (
                  <div 
                    ...
                    className={`bg-white group p-8 rounded-[2.5rem] border-2 transition-all duration-300 hover:shadow-2xl cursor-pointer ${
                      activeTab === 'cancelled' ? 'border-rose-50 hover:border-rose-200' : 'border-slate-50 hover:border-black'
                    }`}
                  >
                    <div className="flex justify-between items-start mb-8">
                        ...
                        <span className={`text-[9px] font-black uppercase px-3 py-1 rounded-md border ${
                             d.status === 'Confirmed' ? 'border-emerald-200 text-emerald-600 bg-emerald-50' : 'border-rose-200 text-rose-600 bg-rose-50'
                        }`}>{d.status}</span>
                    </div>
          ...
          <div className="bg-white w-full max-w-lg rounded-[3rem] shadow-[0_40px_80px_-15px_rgba(0,0,0,0.3)] overflow-hidden border border-slate-100">
            <div className="p-10 md:p-14">
              ...
              <button 
                ...
                className={`w-full mt-12 py-5 rounded-2xl font-black uppercase text-xs tracking-[0.3em] shadow-xl transition-all active:scale-95 ${
                  activeTab === 'planned' ? 'bg-black text-white' : 'bg-rose-600 text-white shadow-rose-200'
                }`}
              >
                Exit Overview
              </button>
