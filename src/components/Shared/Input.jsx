export const Input = ({ label, icon: Icon, ...props }) => (
  <div className="space-y-1.5 w-full">
    ...
    <div className="relative">
      ...
      <input 
        className={`w-full ${Icon ? 'pl-11' : 'pl-4'} pr-4 py-3 rounded-xl border border-gray-200 focus:border-[#632281] focus:ring-2 focus:ring-purple-100 outline-none transition-all`} 
        {...props} 
      />
    </div>
  </div>
